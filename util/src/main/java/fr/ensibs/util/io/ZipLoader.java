 ...
 * at the ZIP root.
 *
 * Implementations of this interface should be given a {@link JsonLoader} and a {@link TextLoader}
...
public interface ZipLoader
{
     ...
     * input and the value its content loaded using the appropriate loader ({@link JsonLoader}
     * or {@link TextLoader}) given the extension of the entry name
     *
     ...
     * using the appropriate loader ({@link JsonLoader} or {@link TextLoader}) given the
